...
const STRATEGY_COPY: Record<string, { eyebrow: string; title: string; description: string; headline: string; deck: string; footer: string }> = {
  contingent: {
    ...
    description: "Chris Moscato owns every new contingent conversation. Flat fee by salary band, billed on start. No deposit. Name, email, and company get you through.",
    headline: "Start a search.",
    deck: "Chris Moscato owns every new contingent conversation. Flat fee by salary band, billed on start. No deposit. Name, email, and company get you through. Email us if you would rather skip the form.",
