          ...
          <div className="grid md:grid-cols-[1fr_auto] gap-10 md:gap-16 items-end">
            <div>
              ...
              <p className="text-base sm:text-lg text-zinc-400 max-w-2xl leading-[1.55] mb-6">
                Contingent is a flat fee by salary band, invoiced when the hire starts. No deposit. When a team needs someone inside the function, Rebel embeds as Head of Talent and leaves them the ATS, scorecards, and playbooks. Rebel Command stays with us.
              </p>
