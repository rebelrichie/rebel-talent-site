    ...
    "itemListElement": [
      {
        ...
        "itemOffered": {
          ...
          "description": "One role. Flat fee by salary band, invoiced when the search starts. No percentage of salary. No deposit.",
...
const PATHS = [
  {
    ...
    kicker: "Contingent",
    title: "Fill one seat.",
    body: "One role. The fee is flat, set by the salary band, and invoiced when the search starts. Not when the candidate accepts. There is no percentage of salary and no deposit. The long version is on the contingent page.",
