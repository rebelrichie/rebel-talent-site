...
const PATHS = [
  {
    ...
    kicker: "Contingent",
    title: "Fill one seat.",
    body: "One role. The fee is flat, set by the salary band, and invoiced when the hire starts. Not when the candidate accepts. There is no percentage of salary and no deposit. The long version is on the contingent page.",
...
const PROOF = [
  {
    ...
    body: "Nine placements. About $294K in agency fees avoided, at a 3.3x return, with an average time to hire under 30 days.",
  },
  {
    client: "Kalibri Labs",
