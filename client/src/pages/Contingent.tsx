...
const FAQS = [
  {
    ...
    a: "You are invoiced when the hire starts. You do not pay a percentage of salary. The fee is locked to the band you approved. There is no deposit. Rebel stays on the search. We also leave you the process notes from the search, which most agencies do not.",
  },
  {
  ...
  },
  {
    ...
    a: "When the hire starts. Not when the candidate accepts, not when we submit, and not on day 30. There is no deposit. A replacement guarantee applies only if we agree to one in writing.",
  },
  {
...
const BAND_STEPS = [
  ...
  },
  {
    ...
    title: "Billed when they start",
    body: "The invoice goes out when the hire starts. There is no retainer and no deposit on this model.",
  },
];
...
const COMPARE = [
  {
    title: "Contingent",
    tag: "THIS PAGE",
    body: "One role, or a few. Flat fee by salary band, invoiced when the hire starts.",
    href: "/contingent",
  },
  {
    title: "Retained",
      ...
      <section data-testid="section-hero" className="relative overflow-hidden bg-rebel-space">
        ...
        <div className="relative max-w-7xl mx-auto px-6 lg:px-12 pt-16 sm:pt-24 lg:pt-32 pb-12 sm:pb-16 z-10">
          ...
          <p className="mt-6 sm:mt-8 text-base sm:text-xl text-zinc-400 max-w-2xl leading-[1.55]">
            You set the range. We lock the fee. You are invoiced when the hire starts. No percentage of salary. No deposit.
          </p>
          ...
          <ScrollReveal variant="fade-up">
            <div className="mb-12 max-w-2xl">
              ...
              <p className="text-zinc-400 text-sm mt-3 leading-relaxed">
                You choose the salary band for the role. Each band has one flat fee, agreed before we start. Paying at the top of the range does not raise it. The invoice goes out when the hire starts. There is no retainer and no deposit on this model.
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal variant="scale">
            <div className="border border-zinc-800 bg-gradient-to-r from-rebel-red/10 to-transparent p-8 sm:p-10 text-center">
              ...
              <p className="text-zinc-400 text-sm mb-6 max-w-lg mx-auto">
                Flat fee by salary band, invoiced when the hire starts. Email us or book the call from here.
              </p>
