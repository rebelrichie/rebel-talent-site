        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <div className="flex flex-col gap-2.5">
              ...
              <a href="https://www.linkedin.com/newsletters/rebel-built-7412825035092045824/" target="_blank" rel="noopener noreferrer" data-testid="link-footer-newsletter" className="text-zinc-400 text-sm no-underline hover:text-white transition-colors">Rebel Built Newsletter</a>
