          ...
          <ScrollReveal variant="fade-up">
            <div>
              ...
              <p className="text-zinc-300 text-base sm:text-lg leading-[1.7] max-w-xl">
                Most firms take a percentage of the offer, so they make more when you pay more. We do not. You pick the salary range for the role. We lock a flat fee to that band before the search starts. The invoice is due when the search starts, not when the candidate accepts. There is no deposit. If you hire at the top of the range, the fee does not move.
              </p>
