...
// Conveys: open capacity across four offerings (Embedded/Fractional,
// Retained Search, Contingent, Advisory), all under Richie's direction.
  ...
  return (
    <div className={`inline-flex items-center gap-2 px-4 py-2 border border-zinc-800 rounded-full bg-zinc-900/50 ${className}`}>
      ...
      <span className="text-emerald-300 text-xs sm:text-sm font-mono tracking-wider uppercase">
        Capacity open · embedded, retained, contingent &amp; advisory under Richie
      </span>
    </div>
  );
}
